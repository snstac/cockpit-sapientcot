...
export const Application: React.FC = () => {
    ...
    const handleEnvVarFormSubmit = useCallback(
        async (e: React.FormEvent) => {
            ...
            const newConfig = serializeEnvDefault(fileLines, envVarForm, CONF_PARAMS, '# Added by Cockpit SAPIENTCOT');
            setSaveBusy(true);
            try {
                await cockpit
    ...
    return (
        <div data-testid="sapientcot-app">
            {toast && (
                <Alert
            ...
            <TlsUploadCard
                tlsDir="/etc/sapientcot/tls"
                keyUser="sapientcot"
                testIdPrefix="sapientcot"
                onToast={setToast}
                onInstalledPaths={onTlsInstalled}
            />

            <Card
                className="sapientcot-expandable-card"
                isExpanded={isConfigExpanded}
                data-testid="sapientcot-config-card"
            >
                <CardHeader
                    className="ct-card-expandable-header"
                    onExpand={() => setIsConfigExpanded(!isConfigExpanded)}
                    toggleButtonProps={{
                        id: 'sapientcot-config-expand',
                ...
                <CardExpandableContent>
                    ...
                    <form onSubmit={handleEnvVarFormSubmit}>
                        <div className="sapientcot-config-form-layout" data-testid="sapientcot-config-form-layout">
                            <div className="sapientcot-config-body-scroll" data-testid="sapientcot-config-scroll">
                            ...
                            <div className="sapientcot-config-actions">
                                <Checkbox
                                id="sapientcot-save-restart"
                                label={_('Restart sapientcot after save')}
            ...
            <Card className="sapientcot-expandable-card" isExpanded={isDebugExpanded}>
                <CardHeader
                    className="ct-card-expandable-header"
                    onExpand={() => setIsDebugExpanded(!isDebugExpanded)}
                    toggleButtonProps={{
                        id: 'sapientcot-debug-expand',
            ...
            <Card className="sapientcot-expandable-card" isExpanded={isAdvancedExpanded}>
                <CardHeader
                    className="ct-card-expandable-header"
                    onExpand={() => setIsAdvancedExpanded(!isAdvancedExpanded)}
                    toggleButtonProps={{
                        id: 'sapientcot-advanced-expand',
